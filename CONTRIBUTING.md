# Contributing to Darbot Windows Agent

Thank you for your interest in contributing to Darbot Windows Agent! This document provides guidelines and instructions for contributing to this project.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/darbot-windows-agent.git
...
Thank you for contributing to Darbot Windows Agent!