...
from darbot_windows_agent.agent.views import AgentState, AgentStep, AgentResult, Action, AgentData
from darbot_windows_agent.tree.views import TreeState, TreeElementNode, TextElementNode, ScrollElementNode, BoundingBox, Center

class TestAgentViews:
    """
    Tests for the data models and view-related classes in darbot_windows_agent.agent.views.
    """
