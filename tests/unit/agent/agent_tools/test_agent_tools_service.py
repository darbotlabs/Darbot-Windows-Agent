...
from darbot_windows_agent.agent.tools.service import (
    done_tool,
    launch_tool,
    shell_tool,
    clipboard_tool,
...
from darbot_windows_agent.agent.tools.views import (
    Click,
    Type,
    Launch,
    Scroll,
...
class TestAgentToolsService:
    """
    Tests for the tool functions in darbot_windows_agent.agent.tools.service.
    """
    ...
    def mock_cursor(self):
        ...
        """
        with patch("darbot_windows_agent.agent.tools.service.cursor") as mock:
            yield mock
    ...
    @patch("darbot_windows_agent.agent.tools.service.pg.sleep")
    ...
    @patch("darbot_windows_agent.agent.tools.service.pc")
    ...
    @patch("darbot_windows_agent.agent.tools.service.uia")
    ...
    @patch("darbot_windows_agent.agent.tools.service.requests")
    @patch("darbot_windows_agent.agent.tools.service.markdownify")
