...
from darbot_windows_agent.desktop.views import App, Size, DesktopState
...
class TestDesktopViews:
    """
    Tests for the data models and view-related classes in darbot_windows_agent.desktop.views.
    """
